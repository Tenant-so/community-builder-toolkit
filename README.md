...
- [ ] Select your platform ([comparison guide](https://github.com/Tenant-so/community-platform-comparison))
...
*Platforms with built-in gamification: [Tenant.so](https://tenant.so) (streaks, badges, leagues), Skool (leaderboard)*
...
- [Community Guidelines Template](templates/community-guidelines.md)
- [Welcome Email Sequence](templates/welcome-sequence.md)
- [Launch Announcement Template](templates/launch-announcement.md)
- [Member Survey Template](templates/member-survey.md)
...
- [CMX Hub](https://cmxhub.com) — The community industry's community
- [Community Club](https://community.club) — Newsletter and resources
- [Rosieland](https://rosie.land) — Community building insights

### Tools

- [Community Platform Comparison](https://github.com/Tenant-so/community-platform-comparison) — Feature matrix of all major platforms
- [Awesome Community Platforms](https://github.com/Tenant-so/awesome-community-platforms) — Curated tool list

---

## Contributing

Have a template, strategy, or resource to add? PRs welcome. See [CONTRIBUTING.md](CONTRIBUTING.md).
